      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 py-10 sm:py-12 relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 sm:gap-10">
          ...
          <div className="col-span-1">
            ...
            >
              <a href="#" className="w-8 h-8 sm:w-10 sm:h-10 rounded-full bg-gray-800/50 flex items-center justify-center hover:bg-purple-600 transition-all duration-300 transform hover:scale-110">
              ...
              <a href="#" className="w-8 h-8 sm:w-10 sm:h-10 rounded-full bg-gray-800/50 flex items-center justify-center hover:bg-blue-600 transition-all duration-300 transform hover:scale-110">
                <svg className="w-4 h-4 sm:w-5 sm:h-5 text-gray-300" fill="currentColor" viewBox="0 0 24 24">
              ...
              <a href="#" className="w-8 h-8 sm:w-10 sm:h-10 rounded-full bg-gray-800/50 flex items-center justify-center hover:bg-indigo-600 transition-all duration-300 transform hover:scale-110">
                <svg className="w-4 h-4 sm:w-5 sm:h-5 text-gray-300" fill="currentColor" viewBox="0 0 24 24">
