		...
		<div className="min-h-screen bg-black text-white px-4 pb-10">
			...
			>
				...
				<div className="hidden md:flex items-center space-x-8">
					...
					<Link
						to="/reviews"
						className="text-purple-400 hover:text-white transition-colors text-sm font-medium"
					>
						Reviews
					</Link>
					<Link to="/login">
						<button className="bg-white text-black px-4 py-2 rounded-lg hover:bg-gray-100 text-sm font-medium">
							Login
						</button>
					</Link>
					<Link to="/signup">
						<button className="bg-purple-600 text-white px-4 py-2 rounded-lg hover:bg-purple-700 text-sm font-medium ml-2">
							Sign Up
						</button>
					</Link>
				</div>
